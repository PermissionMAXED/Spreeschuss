...
export const PACKS = [
  {
    ...
    files: [
      model(
        ...
        [consumer("building.carrot-market", "src/scenes/city/world.ts", "this.assets.clone(`building.${lot.shop}`)")],
      ),
      model(
        "Models/GLB format/building-b.glb",
        "assets/vendor/city-kit-commercial/fluff-salon.glb",
        "Visible Fluff Salon facade",
        [consumer("building.fluff-salon", "src/scenes/city/world.ts", "this.assets.clone(`building.${lot.shop}`)")],
      ),
  ...
  },
  {
    ...
    files: [
      model(
        ...
        [consumer("building.cloud-boutique", "src/scenes/city/world.ts", "this.assets.clone(`building.${lot.shop}`)")],
      ),
