...
export class GoobySaysGame implements MinigameModule {
  ...
  private finishGame(outcome: "win" | "lose" | "quit" = "lose"): void {
    ...
    if (receipt) this.emitFeedback(outcome === "lose" ? "lose" : "win");
  }
    ...
    return `
      ...
      <section class="says-panel" data-panel="tutorial">
        <div class="panel-card">
          ...
          <button class="primary" data-action="begin">START THE SHOW</button><button class="secondary" data-action="quit">QUIT TUTORIAL</button>
        </div>
      </section>
...
const saysStyles = `
  .gooby-says{position:relative;isolation:isolate;width:100%;height:100%;min-height:620px;padding-bottom:env(safe-area-inset-bottom);overflow:hidden;color:#33314b;background:#31285d;font-family:Nunito,ui-rounded,"Arial Rounded MT Bold",system-ui,sans-serif;touch-action:manipulation;user-select:none}.gooby-says *{box-sizing:border-box}.gooby-says button{min-width:44px;min-height:44px;font:inherit}
