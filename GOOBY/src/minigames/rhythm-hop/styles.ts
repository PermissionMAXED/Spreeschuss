export const RHYTHM_HOP_STYLES = `
  ...
  * { box-sizing:border-box; }
  ...
  .grade{margin:8px 0;color:#f0ad43;font-size:52px;font-weight:1000;text-shadow:0 4px #9c633b}.result-score{color:#493a78;font-size:32px;font-weight:1000}.result-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin:12px 0}.result-grid div{padding:8px 4px;border-radius:13px;background:#d8cdf0}.result-grid b,.result-grid span{display:block}.result-grid b{font-size:15px}.result-grid span{font-size:8px;font-weight:900;text-transform:uppercase}.new-best{display:inline-block;margin-bottom:11px;padding:5px 10px;border-radius:99px;color:#8b5d1f;background:#ffe798;font-size:9px;font-weight:950;letter-spacing:1px}
