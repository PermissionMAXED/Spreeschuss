...
export function addCallouts(group, map, sites) { // eslint-disable-line no-unused-vars
  // Local PRNG (rule 2) — NEVER the shared builder rand.
  const rnd = mulberry32(hashStr((map.id || map.name || 'map') + ':callouts')); // eslint-disable-line no-unused-vars
