...
export function addLightShafts(group, map, sites) { // eslint-disable-line no-unused-vars
  // Local PRNG (rule 2) — NEVER the shared builder rand.
  const rnd = mulberry32(hashStr((map.id || map.name || 'map') + ':lightshafts')); // eslint-disable-line no-unused-vars
